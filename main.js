const SITE_DATA = {
  ...
  DRESSCODE_TEXT: "<p>Мы рады сообщить, что дресс-кода на нашей свадьбе не будет. Будем благодарны, если вы выберете однотонные образы без броских принтов.</p><p>Но если вы хотите поддержать цветовую гамму нашей свадьбы, мы будем рады.</p>",
